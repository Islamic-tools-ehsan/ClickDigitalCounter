    ...
    <div className="relative flex items-center justify-center w-64 h-64">
      ...
      <svg className="absolute w-full h-full -rotate-90 filter drop-shadow-sm">
        ...
        <circle
          ...
          cy="50%"
          r={radius}
          className={`fill-none transition-all duration-500 ease-out stroke-current ${isTargetReached ? 'text-emerald-400 stroke-[8px] animate-pulse' : (isDarkMode ? 'text-emerald-400' : 'text-emerald-600')}`}
          strokeWidth="4"
